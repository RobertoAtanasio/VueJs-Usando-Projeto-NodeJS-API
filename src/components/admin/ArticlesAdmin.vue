...
export default {
    ...
    methods: {
        ...
        //             "description": "O artigo aborta os aspectos da VueJS..."
        //         },
        //         {
        //             "id": 7,
        //             "name": "15 Motivos para Usar VueJS parte 2",
        //             "description": "O artigo aborta os aspectos do teste..."
        //         }
        //     ],
        //     "count": 2,
        //     "limit": 10
    ...
    watch: {
        ...
        isMudouCategoria() {
            this.loadCategories()
            this.$store.state.isMudouCategoria = false
        }
    },
    mounted() {
        this.loadUsers()
